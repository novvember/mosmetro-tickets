...
function Info() {
  return (
    <section className="info">
      <h2 className="info__title">О приложении</h2>
      ...
      <div className="info__content">
        ...
        <h3>Что это дает?</h3>
        <p>
          Во-первых, можно подобрать себе самый выгодный билет. Найдите
          на графике точку, соответсвующую вашему количеству ежемесячных
          поездок, — получите, сколько это будет стоить, и сам билет.
        </p>
        <p>
          Во-вторых, по-моему, здорово, что можно посмотреть на график и сразу
          оценить все варианты: например, какие билеты выгодны и на какие
          профили поездок расчитаны, а какие билеты стоят слишком много и почти
          никогда не становятся выгодными.
        </p>

        <h3>Как пользоваться?</h3>
        <p>
          По горизонтальной оси нужно выбрать количество поездок на метро
          в течение месяца, а по вертикально — количество поездок на наземном
          транспорте. На пересечении будет информация об оптимальном билете
          и стомости. Стоимость указывается в пересчете на месяц (30 дней).
        </p>
        <p>
          Справа можно отключить ненужные билеты (например, не все готовы
          покупать выгодный годовой проездной) — график пересчитается
          автоматически.
        </p>
        ...
        <p>
          Для каждого случая (столько-то поездок на метро и столько-то
          на наземном транспорте) приложение прямо внутри браузера считает
          стоимость всех билетов и показывает оптимальный вариант.
        </p>

        <h3>Что не учитывается?</h3>
        <p>
          Из существующих билетов не считаются только льготные (школьные)
          и некоторые случаи совместного исползования билетов (наиболее
          актуальные сочетания все-таки учтены). Также не считается всё, что
          действует за пределами МКАД (то есть вне «Центральной» зоны): МЦД
          в зоне «Пригород», автобусы в зоне Б.
        </p>
        <p>
        ...
        <h3>Нашли ошибку?</h3>
        <p>
          Если что-то не так вообще или не так считается, напишите мне об этом
          или создайте пул-реквест, если знаете как. Ссылки под графиком.
        </p>
